...
const ProjectSection = () => {
  return (
    <div className='project-section-full w-full mb-24 hidden md:block' id="project">
        ...
        <div className='project-section-body px-10 flex flex-col items-center'>
            ...
            <div className='project-copy-and-picture flex justify-between mb-4'>
                ...
                <div className='project-image w-[40%] flex items-center justify-center overflow-hidden '>
                    <img className='max-w-full object-cover' src="/images/project_primary.jpeg" />
                </div>

                <div className='project-description w-[50%] '>
                    <h1    className='mt-0'>OUR PROJECT</h1>
                    <p className=''>
