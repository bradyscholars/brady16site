...
const CAndWSection = () => {
  return (
    <div className='c-and-w-section flex flex-col w-full items-center '>

        <BigHeader text={"C&W FOUNDATION"} />

        <div className='c-and-w-copy w-full flex justify-between items-center px-10 mb-24'>
